...
public class Lab13{
   public static void gameLoop(){
      ...
      boolean[] possible_moves = {true,true,true,true,true,true,true,true,true}; //stops computer from choosing invalid moves
      ...
      while(game != 1){
         ...
         String a = JOptionPane.showInputDialog("Enter number from 0 to 8:");
         char b = a.charAt(0);
         ...
         int user_input = Integer.parseInt(a);     
         if((user_input > 8) || (user_input<0)){
            JOptionPane.showMessageDialog(null, "Move cannot be greater than 8");
            continue;
         }
